...
| 第7章 | ドメインモデルをPostgreSQLに落とし込む ─ NoSQL経験者の視点から |
| 第8章 | 依存の方向をコードで検証する ─ レイヤーアーキテクチャの守り方 |
| 第9章 | プリミティブ型の罠 ─ BalanceとWishItemNameで学ぶ値オブジェクトの本質 |
| 第10章 | InMemoryRepository ─ DBなしでユースケースを証明する |
| 第11章 | new() と reconstitute() ─ 集約の2つのコンストラクタ |
